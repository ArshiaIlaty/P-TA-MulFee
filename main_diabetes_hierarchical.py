...
def train_with_hierarchical_discriminators(
    ...
    """
    Enhanced training pipeline with hierarchical discriminators
    """
    device = torch.device(
        "cuda:1"
...
def generate_final_synthetic_dataset(
    ...
    if synthetic_data:
        ...
        output_path = f"{save_path}/output_hierarchical.csv"
...
def evaluate_hierarchical_system(
    real_csv="diabetes.csv", synthetic_csv="output_hierarchical.csv"
):
    """
    Evaluate the hierarchical system performance
    """
    logger.info("Evaluating hierarchical system performance...")
    ...
    try:
        ...
        from evaluate_diabetes import train_and_evaluate

        train_and_evaluate(synthetic_csv, real_csv, "diabetes")
...
if __name__ == "__main__":
    try:
        logger.info("Starting hierarchical P-TA training pipeline...")
        ...
        logger.info("Hierarchical P-TA pipeline completed successfully!")
