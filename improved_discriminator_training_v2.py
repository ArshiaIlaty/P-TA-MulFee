...
class ImprovedDiscriminatorTrainingV2:
    """
    Improved discriminator training with fixes for sentence discriminator and optimized weights
    """
    ...
    def __init__(self, hierarchical_discriminators, device="cuda"):
        ...
        # Fix sentence discriminator - use BERT instead of GPT-2
    ...
    def alternating_training(
        ...
        real_data, 
        synthetic_data, 
        num_cycles=10,  # Increased from 2 to 10
    ...
    def train_generator_with_feedback(self, generator, real_data, epochs=3, batch_size=16):
        ...
        optimized_weights = {
            'token': 0.2,
            'sentence': 0.0,  # Disabled until fixed
    ...
    def evaluate_discriminator_performance(self, real_data, synthetic_data, num_samples=100):
        """
        Evaluate discriminator performance with AUC and accuracy metrics
        """
    ...
    def plot_impact_analysis_v2(self, save_path='impact_analysis_v2.png'):
        """
        Enhanced impact analysis plot with discriminator performance
        """
        ...
        plt.subplot(2, 3, 5)
        if self.training_history:
            # Get the last cycle's detailed losses
            last_cycle = self.training_history[-1]
        ...
        logger.info(f"Enhanced impact analysis plot saved to {save_path}")

def main():
    """
    Example usage of improved discriminator training v2
    """
    # Initialize wandb
    try:
        wandb.init(project="improved-discriminator-training", name="heloc-v2-fixed")
    except:
    ...
    # Initialize improved training framework v2
    logger.info("Initializing improved training framework v2...")
    improved_trainer = ImprovedDiscriminatorTrainingV2(hierarchical_discriminators, device)
    ...
    # Generate enhanced impact analysis plot
    logger.info("Generating enhanced impact analysis plot...")
    improved_trainer.plot_impact_analysis_v2('heloc_impact_analysis_v2.png')
    logger.info("Enhanced impact analysis plot saved to heloc_impact_analysis_v2.png")
    ...
    logger.info("Comprehensive results saved to training_results_v2.json")
    
    logger.info("Improved discriminator training v2 completed!")
