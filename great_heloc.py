...
def train_great(
    csv_path="heloc.csv", model_name="gpt2", save_pth="./gpt2_finetuned_heloc"
):
    ...
    def tokenize_function(examples):
        ...
        )  # Increased sequence length for HELOC (more features)
    ...
    training_args = TrainingArguments(
        output_dir="./gpt2_finetuned_heloc",
