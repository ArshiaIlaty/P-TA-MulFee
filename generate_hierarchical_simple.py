...
def generate_synthetic_data_simple(
    ...
    """
    Generate synthetic data using hierarchical fine-tuned model without discriminators
    """
...
def generate_synthetic_dataset_simple(
    model, tokenizer, real_texts, device, output_file="output_hierarchical.csv"
):
    """
...
def main():
    ...
    """
    try:
        logger.info("=== STARTING HIERARCHICAL SYNTHETIC DATA GENERATION (SIMPLE) ===")
